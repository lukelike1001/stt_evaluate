...
def evaluate_whisper_tiny(input_audio="16kHz/audio_0.wav", input_reference=""):
...
if __name__ == "__main__":
    ...
    for k in range(len(msg)):
        curr_transcript, curr_wer = evaluate_whisper_tiny(input_audio=f"16kHz/audio_{k}.wav", input_reference=msg[k])
