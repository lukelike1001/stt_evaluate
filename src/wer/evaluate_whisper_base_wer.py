...
def evaluate_whisper_base(input_audio="16kHz/audio_0.wav", input_reference=""):
...
if __name__ == "__main__":
    ...
    stt_transcripts = ["" for i in range(12)]
    
    # Evaluate all of the inputs
    wer_array, wer_mean = [], 0
    for k in range(len(msg)):
        curr_transcript, curr_wer = evaluate_whisper_base(input_audio=f"16kHz/audio_{k}.wav", input_reference=msg[k])
